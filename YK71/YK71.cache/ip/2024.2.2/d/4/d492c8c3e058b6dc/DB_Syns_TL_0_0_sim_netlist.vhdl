...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ DB_Syns_TL_0_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pulse_start is
  port (
    CLK_Sys_out : out STD_LOGIC;
    CLK_Freq_in : in STD_LOGIC;
    reset_rtl : in STD_LOGIC
  );
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pulse_start;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pulse_start is
  ...
  signal \signal_pulse0_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \signal_pulse0_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \signal_pulse0_carry__0_i_3_n_0\ : STD_LOGIC;
  signal \signal_pulse0_carry__0_n_2\ : STD_LOGIC;
  signal \signal_pulse0_carry__0_n_3\ : STD_LOGIC;
  signal signal_pulse0_carry_i_1_n_0 : STD_LOGIC;
  signal signal_pulse0_carry_i_2_n_0 : STD_LOGIC;
  signal signal_pulse0_carry_i_3_n_0 : STD_LOGIC;
  signal signal_pulse0_carry_i_4_n_0 : STD_LOGIC;
  signal signal_pulse0_carry_i_5_n_0 : STD_LOGIC;
  signal signal_pulse0_carry_i_6_n_0 : STD_LOGIC;
  signal signal_pulse0_carry_n_0 : STD_LOGIC;
  signal signal_pulse0_carry_n_1 : STD_LOGIC;
  signal signal_pulse0_carry_n_2 : STD_LOGIC;
  signal signal_pulse0_carry_n_3 : STD_LOGIC;
  ...
  signal NLW_signal_pulse0_carry_O_UNCONNECTED : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_signal_pulse0_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  signal \NLW_signal_pulse0_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  ...
  attribute COMPARATOR_THRESHOLD of signal_pulse0_carry : label is 11;
  attribute COMPARATOR_THRESHOLD of \signal_pulse0_carry__0\ : label is 11;
begin
...
signal_pulse0_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => signal_pulse0_carry_n_0,
      CO(2) => signal_pulse0_carry_n_1,
      CO(1) => signal_pulse0_carry_n_2,
      CO(0) => signal_pulse0_carry_n_3,
      CYINIT => '0',
      DI(3) => '0',
      DI(2) => signal_pulse0_carry_i_1_n_0,
      DI(1) => '0',
      DI(0) => signal_pulse0_carry_i_2_n_0,
      O(3 downto 0) => NLW_signal_pulse0_carry_O_UNCONNECTED(3 downto 0),
      S(3) => signal_pulse0_carry_i_3_n_0,
      S(2) => signal_pulse0_carry_i_4_n_0,
      S(1) => signal_pulse0_carry_i_5_n_0,
      S(0) => signal_pulse0_carry_i_6_n_0
    );
\signal_pulse0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => signal_pulse0_carry_n_0,
      CO(3) => \NLW_signal_pulse0_carry__0_CO_UNCONNECTED\(3),
      CO(2) => p_0_in,
      CO(1) => \signal_pulse0_carry__0_n_2\,
      CO(0) => \signal_pulse0_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_signal_pulse0_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3) => '0',
      S(2) => \signal_pulse0_carry__0_i_1_n_0\,
      S(1) => \signal_pulse0_carry__0_i_2_n_0\,
      S(0) => \signal_pulse0_carry__0_i_3_n_0\
    );
\signal_pulse0_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\signal_pulse0_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\signal_pulse0_carry__0_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
signal_pulse0_carry_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
signal_pulse0_carry_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
signal_pulse0_carry_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
signal_pulse0_carry_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
signal_pulse0_carry_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
signal_pulse0_carry_i_6: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
signal_pulse_reg: unisim.vcomponents.FDCE
    generic map(
      INIT => '1'
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Syns_TL_slave_lite_v1_0_S00_AXI is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Syns_TL_slave_lite_v1_0_S00_AXI;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Syns_TL_slave_lite_v1_0_S00_AXI is
...
PULSE_CTRL_INST: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_pulse_start
     port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Syns_TL is
  port (
...
end decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Syns_TL;

architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Syns_TL is
begin
Syns_TL_slave_lite_v1_0_S00_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Syns_TL_slave_lite_v1_0_S00_AXI
     port map (
      CLK_Freq_in => CLK_Freq_in,
      CLK_Sys_out => CLK_Sys_out,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "DB_Syns_TL_0_0,Syns_TL,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "yes";
  attribute x_core_info : string;
  attribute x_core_info of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "Syns_TL,Vivado 2024.2.2";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_mode of reset_rtl : signal is "slave reset_rtl";
  ...
  attribute x_interface_parameter of s00_axi_aclk : signal is "XIL_INTERFACENAME S00_AXI_CLK, ASSOCIATED_BUSIF S00_AXI, ASSOCIATED_RESET s00_axi_aresetn, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN DB_processing_system7_0_0_FCLK_CLK0, INSERT_VIP 0";
...
U0: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_Syns_TL
     port map (
      CLK_Freq_in => CLK_Freq_in,
      CLK_Sys_out => CLK_Sys_out,

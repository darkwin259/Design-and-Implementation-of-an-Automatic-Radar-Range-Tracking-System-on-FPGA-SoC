...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_YK71_Hardware_Core is
  ...
  attribute SOFT_HLUTNM of cp3_state_i_6 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of cp3_state_i_7 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of csbs1_out_INST_0_i_3 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of csbs1_out_INST_0_i_4 : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of r_out_INST_0_i_3 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of r_out_INST_0_i_4 : label is "soft_lutpair3";
...
csbs1_out_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"20000000"
    )
        port map (
...
csbs1_out_INST_0_i_4: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
csbs1_out_INST_0_i_5: unisim.vcomponents.LUT6
    generic map(
...
csbs2_out_INST_0: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
csbs2_out_INST_0_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFFAAA2A2A2"
    )
        port map (
      I0 => \tail_cnt_reg_n_0_[13]\,
      I1 => csbs2_out_INST_0_i_4_n_0,
...
\energy_e_reg[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\energy_l_reg[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_YK71_Tracker_AXI_slave_lite_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_state_write[2]_i_1\ : label is "soft_lutpair4";

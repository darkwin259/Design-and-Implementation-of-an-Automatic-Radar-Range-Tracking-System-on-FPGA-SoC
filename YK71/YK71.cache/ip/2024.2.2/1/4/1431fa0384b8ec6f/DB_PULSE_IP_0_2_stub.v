...
(* CHECK_LICENSE_TYPE = "DB_PULSE_IP_0_2,PULSE_IP,{}" *) (* core_generation_info = "DB_PULSE_IP_0_2,PULSE_IP,{x_ipProduct=Vivado 2024.2.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=PULSE_IP,x_ipVersion=1.0,x_ipCoreRevision=4,x_ipLanguage=VHDL,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=4}" *) (* downgradeipidentifiedwarnings = "yes" *) 

...
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ YK71_Tracker_AXI_0_sim_netlist.vhdl
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_YK71_Hardware_Core is
  port (
    ...
    \target_pos_out_reg[17]_0\ : out STD_LOGIC_VECTOR ( 17 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_YK71_Hardware_Core is
  ...
  signal cp3_state_i_1_n_0 : STD_LOGIC;
  ...
  signal cycle_cnt_reg : STD_LOGIC_VECTOR ( 17 downto 0 );
  ...
  signal \NLW_cycle_cnt_reg[16]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_cycle_cnt_reg[16]_i_1_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute SOFT_HLUTNM of cp3_state_i_6 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of cp3_state_i_7 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of csbs1_out_INST_0_i_2 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of csbs2_out_INST_0_i_4 : label is "soft_lutpair2";
  attribute COMPARATOR_THRESHOLD of r_out2_carry : label is 11;
  attribute COMPARATOR_THRESHOLD of \r_out2_carry__0\ : label is 11;
  attribute SOFT_HLUTNM of r_out_INST_0_i_2 : label is "soft_lutpair2";
...
\cp3_limit_reg[10]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\cp3_limit_reg[11]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\cp3_limit_reg[5]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\cp3_limit_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\cp3_limit_reg[8]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\cp3_limit_reg[9]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '1'
    )
        port map (
...
\cp3_state1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CYINIT => '0',
      DI(3 downto 1) => B"000",
      DI(0) => \cp3_state1_carry__1_i_1_n_0\,
      O(3 downto 0) => \NLW_cp3_state1_carry__1_O_UNCONNECTED\(3 downto 0),
      S(3) => \cp3_state1_carry__1_i_2_n_0\,
      S(2) => \cp3_state1_carry__1_i_3_n_0\,
      S(1) => \cp3_state1_carry__1_i_4_n_0\,
      S(0) => \cp3_state1_carry__1_i_5_n_0\
    );
...
\cp3_state1_carry__1_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\cp3_state1_carry__1_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\cp3_state1_carry__1_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\cp3_state1_carry__2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \cp3_state1_carry__2_i_1_n_0\,
      S(2) => \cp3_state1_carry__2_i_2_n_0\,
      S(1) => \cp3_state1_carry__2_i_3_n_0\,
      S(0) => \cp3_state1_carry__2_i_4_n_0\
    );
\cp3_state1_carry__2_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\cp3_state1_carry__2_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\cp3_state1_carry__2_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\cp3_state1_carry__2_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
cp3_state_i_1: unisim.vcomponents.LUT6
    generic map(
...
cp3_state_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
cp3_state_i_3: unisim.vcomponents.LUT6
    generic map(
...
cp3_state_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
cp3_state_i_5: unisim.vcomponents.LUT6
    generic map(
...
cp3_state_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
cp3_state_i_7: unisim.vcomponents.LUT3
    generic map(
      INIT => X"F8"
    )
        port map (
...
cp3_state_reg: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\cycle_cnt_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 1) => \NLW_cycle_cnt_reg[16]_i_1_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \cycle_cnt_reg[16]_i_1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_cycle_cnt_reg[16]_i_1_O_UNCONNECTED\(3 downto 2),
      O(1) => \cycle_cnt_reg[16]_i_1_n_6\,
      O(0) => \cycle_cnt_reg[16]_i_1_n_7\,
      S(3 downto 2) => B"00",
      S(1 downto 0) => cycle_cnt_reg(17 downto 16)
    );
...
tail_active_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B888"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_YK71_Tracker_AXI_slave_lite_v1_0_S00_AXI is
  ...
  signal target_pos_out : STD_LOGIC_VECTOR ( 17 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_state_write[2]_i_1\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \s00_axi_rdata[0]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \s00_axi_rdata[10]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \s00_axi_rdata[11]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \s00_axi_rdata[12]_INST_0\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \s00_axi_rdata[13]_INST_0\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \s00_axi_rdata[20]_INST_0\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \s00_axi_rdata[21]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \s00_axi_rdata[22]_INST_0\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \s00_axi_rdata[23]_INST_0\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \s00_axi_rdata[24]_INST_0\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \s00_axi_rdata[28]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \s00_axi_rdata[29]_INST_0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \s00_axi_rdata[2]_INST_0\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \s00_axi_rdata[30]_INST_0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \s00_axi_rdata[31]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \s00_axi_rdata[3]_INST_0\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \s00_axi_rdata[4]_INST_0\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \s00_axi_rdata[5]_INST_0\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \s00_axi_rdata[6]_INST_0\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \s00_axi_rdata[7]_INST_0\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \s00_axi_rdata[8]_INST_0\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \s00_axi_rdata[9]_INST_0\ : label is "soft_lutpair13";
begin
...
YK71_Core_Inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_YK71_Hardware_Core
     port map (
      ...
      \target_pos_out_reg[17]_0\(17 downto 0) => target_pos_out(17 downto 0),
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "YK71_Tracker_AXI_0,YK71_Tracker_AXI,{}";

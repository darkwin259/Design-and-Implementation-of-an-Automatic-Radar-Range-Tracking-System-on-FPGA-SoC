...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_YK71_Hardware_Core is
  ...
  attribute SOFT_HLUTNM of csbs1_out_INST_0_i_2 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \tail_cnt[14]_i_6\ : label is "soft_lutpair1";
...
csbs1_out_INST_0_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
csbs2_out_INST_0_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (

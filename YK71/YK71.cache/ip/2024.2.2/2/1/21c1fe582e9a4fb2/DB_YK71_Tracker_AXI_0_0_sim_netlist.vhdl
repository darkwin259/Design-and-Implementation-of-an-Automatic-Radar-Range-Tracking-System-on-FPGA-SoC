...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_YK71_Hardware_Core is
  ...
  signal csbs2_out_INST_0_i_5_n_0 : STD_LOGIC;
  ...
  signal \cycle_cnt_reg_n_0_[16]\ : STD_LOGIC;
  signal \cycle_cnt_reg_n_0_[17]\ : STD_LOGIC;
  ...
  signal \tail_active1__8\ : STD_LOGIC;
  signal tail_active_i_1_n_0 : STD_LOGIC;
  signal tail_cnt : STD_LOGIC;
  signal tail_cnt0 : STD_LOGIC_VECTOR ( 14 downto 1 );
  signal \tail_cnt0_carry__0_n_0\ : STD_LOGIC;
  signal \tail_cnt0_carry__0_n_1\ : STD_LOGIC;
  signal \tail_cnt0_carry__0_n_2\ : STD_LOGIC;
  signal \tail_cnt0_carry__0_n_3\ : STD_LOGIC;
  signal \tail_cnt0_carry__1_n_0\ : STD_LOGIC;
  signal \tail_cnt0_carry__1_n_1\ : STD_LOGIC;
  signal \tail_cnt0_carry__1_n_2\ : STD_LOGIC;
  signal \tail_cnt0_carry__1_n_3\ : STD_LOGIC;
  signal \tail_cnt0_carry__2_n_3\ : STD_LOGIC;
  signal tail_cnt0_carry_n_0 : STD_LOGIC;
  signal tail_cnt0_carry_n_1 : STD_LOGIC;
  signal tail_cnt0_carry_n_2 : STD_LOGIC;
  signal tail_cnt0_carry_n_3 : STD_LOGIC;
  ...
  signal \NLW_tail_cnt0_carry__2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 1 );
  signal \NLW_tail_cnt0_carry__2_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  ...
  attribute SOFT_HLUTNM of cp3_state_i_6 : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of cp3_state_i_7 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of csbs2_out_INST_0_i_4 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of csbs2_out_INST_0_i_5 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of r_out_INST_0 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of r_out_INST_0_i_3 : label is "soft_lutpair2";
  attribute ADDER_THRESHOLD : integer;
  attribute ADDER_THRESHOLD of tail_cnt0_carry : label is 35;
  attribute ADDER_THRESHOLD of \tail_cnt0_carry__0\ : label is 35;
  attribute ADDER_THRESHOLD of \tail_cnt0_carry__1\ : label is 35;
  attribute ADDER_THRESHOLD of \tail_cnt0_carry__2\ : label is 35;
  attribute SOFT_HLUTNM of \tail_cnt[14]_i_4\ : label is "soft_lutpair2";
begin
...
csbs1_out_INST_0_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7777777F"
    )
        port map (
...
csbs1_out_INST_0_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
csbs2_out_INST_0: unisim.vcomponents.LUT5
    generic map(
      INIT => X"AAA8A8A8"
    )
        port map (
...
csbs2_out_INST_0_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
csbs2_out_INST_0_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\cycle_cnt_reg[0]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \cycle_cnt_reg_n_0_[3]\,
      S(2) => \cycle_cnt_reg_n_0_[2]\,
      S(1) => \cycle_cnt_reg_n_0_[1]\,
...
\cycle_cnt_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \cycle_cnt_reg_n_0_[15]\,
      S(2) => \cycle_cnt_reg_n_0_[14]\,
      S(1) => \cycle_cnt_reg_n_0_[13]\,
      S(0) => \cycle_cnt_reg_n_0_[12]\
    );
...
\cycle_cnt_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 2) => B"00",
      S(1) => \cycle_cnt_reg_n_0_[17]\,
      S(0) => \cycle_cnt_reg_n_0_[16]\
    );
...
\cycle_cnt_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \cycle_cnt_reg_n_0_[7]\,
      S(2) => \cycle_cnt_reg_n_0_[6]\,
      S(1) => \cycle_cnt_reg_n_0_[5]\,
      S(0) => \cycle_cnt_reg_n_0_[4]\
    );
...
\cycle_cnt_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \cycle_cnt_reg_n_0_[11]\,
      S(2) => \cycle_cnt_reg_n_0_[10]\,
      S(1) => \cycle_cnt_reg_n_0_[9]\,
      S(0) => \cycle_cnt_reg_n_0_[8]\
    );
...
r_out_INST_0_i_2: unisim.vcomponents.LUT6
    generic map(
...
r_out_INST_0_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"57FFFFFF"
    )
        port map (
...
tail_cnt0_carry: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => tail_cnt0_carry_n_0,
      CO(2) => tail_cnt0_carry_n_1,
      CO(1) => tail_cnt0_carry_n_2,
      CO(0) => tail_cnt0_carry_n_3,
...
\tail_cnt0_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => tail_cnt0_carry_n_0,
      CO(3) => \tail_cnt0_carry__0_n_0\,
      CO(2) => \tail_cnt0_carry__0_n_1\,
      CO(1) => \tail_cnt0_carry__0_n_2\,
      CO(0) => \tail_cnt0_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\tail_cnt0_carry__1\: unisim.vcomponents.CARRY4
     port map (
      CI => \tail_cnt0_carry__0_n_0\,
      CO(3) => \tail_cnt0_carry__1_n_0\,
      CO(2) => \tail_cnt0_carry__1_n_1\,
      CO(1) => \tail_cnt0_carry__1_n_2\,
      CO(0) => \tail_cnt0_carry__1_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\tail_cnt0_carry__2\: unisim.vcomponents.CARRY4
     port map (
      CI => \tail_cnt0_carry__1_n_0\,
      CO(3 downto 1) => \NLW_tail_cnt0_carry__2_CO_UNCONNECTED\(3 downto 1),
      CO(0) => \tail_cnt0_carry__2_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 2) => \NLW_tail_cnt0_carry__2_O_UNCONNECTED\(3 downto 2),
...
\tail_cnt[14]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"CFCFCFCFDFDFFFDF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_YK71_Tracker_AXI_slave_lite_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg4[31]_i_3\ : label is "soft_lutpair6";
begin

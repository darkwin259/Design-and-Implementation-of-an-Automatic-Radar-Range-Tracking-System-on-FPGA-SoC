...
HD_PWD='F:/FPGA_Project/FPGA_YK71/YK71/YK71.runs/DB_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DB_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DB_processing_system7_0_0.tcl
